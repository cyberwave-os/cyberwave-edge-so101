...
from utils.config import get_default_mqtt_port, get_mute_temperature_notifications, get_setup_config_path
...
def main():
    ...
    if setup_config:
        ...
        if setup_config.get("wrist_camera"):
            ...
            camera_name = _camera_name_override(wrist_type)
            if camera_name is not None:
                wrist_entry["camera_name"] = camera_name
            cameras_list.append(wrist_entry)
        ...
        for add in setup_config.get("additional_cameras", []):
            ...
            camera_name = _camera_name_override(camera_type)
            if camera_name is not None:
                add_entry["camera_name"] = camera_name
            cameras_list.append(add_entry)
