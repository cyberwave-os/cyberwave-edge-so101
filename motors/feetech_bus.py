...
from utils.console import tui_enabled
...
class FeetechMotorsBus(MotorsBus):
    ...
    def record_ranges_of_motion(
        ...
        # Closed over by display_loop below.
        ...
        def display_loop():
            ...
            while not stop_recording.is_set():
                # Skip the whole render without a TTY, not just the write: this
                # block holds display_lock while formatting, contending with
                # read_loop's 100 Hz sampling (see utils.console).
                if draw_tui:
                    with display_lock:
                        display_text = self._format_calibration_display(
