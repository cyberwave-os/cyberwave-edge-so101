...
from .tables import (
    ...
    ADDR_MODEL_NUMBER,
    ADDR_MOVING,
    ADDR_MOVING_VELOCITY_THRESHOLD,
    ADDR_OPERATING_MODE,
...
REGISTER_SPECS: tuple[RegisterSpec, ...] = (
    ...
    RegisterSpec("Servo_Sub_Version", *ADDR_SERVO_SUB_VERSION, "read_only", "EEPROM"),
    ...
    RegisterSpec("Goal_Time", *ADDR_GOAL_TIME, "read_write", "SRAM", aliases=("Goal_PWM",)),
    RegisterSpec(
        "Goal_Velocity",
        *ADDR_GOAL_VELOCITY,
        "read_write",
    ...
    RegisterSpec("Async_Write_Flag", *ADDR_ASYNC_WRITE_FLAG, "read_only", "SRAM"),
    RegisterSpec("Status", *ADDR_STATUS, "read_only", "SRAM", aliases=("Hardware_Error_Status",)),
    ...
    RegisterSpec("Vmin", *ADDR_VMIN, "read_write", "SRAM"),
    RegisterSpec("Vmax", *ADDR_VMAX, "read_write", "SRAM"),
    RegisterSpec("Amax", *ADDR_AMAX, "read_write", "SRAM"),
    RegisterSpec("KAcc", *ADDR_KACC, "read_write", "SRAM"),
)
